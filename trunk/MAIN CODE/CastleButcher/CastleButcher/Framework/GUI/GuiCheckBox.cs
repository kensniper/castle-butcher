...
{
    /// <summary>
    /// A check box that has two states: checked and unchecked
    /// </summary>
    public class GuiCheckBox : GuiControl
    {
        ...
        public GuiCheckBox(RectangleF buttonRect)
        ...
        public GuiCheckBox(string name, RectangleF buttonRect)
        ...
        protected override void ProcessStyle(GUIStyle style)
        {
            ...
            normal = style.GetNodeByName("CheckBox").GetNodeByName("Normal");
            over = style.GetNodeByName("CheckBox").GetNodeByName("Over");
            down = style.GetNodeByName("CheckBox").GetNodeByName("Down");
            disabled = style.GetNodeByName("CheckBox").GetNodeByName("Disabled");
            mark = style.GetNodeByName("CheckBox").GetNodeByName("CheckMark");
