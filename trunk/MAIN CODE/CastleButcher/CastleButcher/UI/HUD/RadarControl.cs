...
{
    public class RadarControl : GuiControl
    {
        private Quad normalQuad;

        public RadarControl(PointF position)
            : base(new RectangleF(position, new SizeF(0, 0)), "radar")
        {
        ...
        protected override void ProcessStyle(GUIStyle style)
        {
            ...
            ImageNode normal = style.GetNodeByName("Radar").GetNodeByName("Normal");
