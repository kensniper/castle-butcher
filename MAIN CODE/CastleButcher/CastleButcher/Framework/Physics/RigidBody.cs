...
{
    public abstract class RigidBody : IDynamicPhysicalObject
    {
        protected RigidBodyData m_data;
        protected float m_currentTime;
        protected ObjectType m_type = ObjectType.RigidBody;
        ...
        public RigidBody(PhysicalProperties physProp)
        {
            m_data.Orientation = MyQuaternion.FromEulerAngles(0, 0, 0);
        ...
        public float AngularDragCoefficient
        {
            get
            {
                return physicalProperties.AngularDragCoefficient;
            }
        }
